...
# Create User
# java -cp sd.jar tukano.clients.RestClientClasslass create http://users-1:8080/rest nmp 12345 nmp@nova.pt "Nuno Preguica"

# Get User
# java -cp sd.jar tukano.clients.RestClientClasslass get http://users-1:8080/rest nmp 12345

# Update User
# java -cp sd.jar tukano.clients.RestClientClasslass update http://users-1:8080/rest nmp 12345 hahaha@nova.pt "João Bombaclaat"

# Delete User
# java -cp sd.jar tukano.clients.RestClientClasslass delete http://users-1:8080/rest nmp 12345

# Search Users
# java -cp sd.jar tukano.clients.RestClientClasslass delete http://users-1:8080/rest nmp
